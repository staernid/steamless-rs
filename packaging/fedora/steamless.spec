...
%prep
%autosetup -n steamless-rs-%{version}
...
%changelog
* Fri Jul 31 2026 Staernid <vitezfh@gmail.com> - 1.0.2-1
- Release v1.0.2 with unified workspace versioning and C ABI library target steamless_c
